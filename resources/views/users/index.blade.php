...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <!-- CSS Files -->
    <link href="/material/css/material-dashboard.css?v=2.1.3" rel="stylesheet" />
  ...
  <body class="clickup-chrome-ext_installed">
    ...
    <!-- End Google Tag Manager (noscript) -->
          ...
          <div class="wrapper ">
            <div class="sidebar" data-color="orange" data-background-color="white" data-image="/material/img/sidebar-1.jpg">
              <!--
                ...
                <ul class="nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#laravelExample" aria-expanded="true">
                      <i><img style="width:25px" src="/material/img/laravel.svg"></i>
          ...
          <ul class="dropdown-menu">
            ...
            <li class="active">
              <a class="img-holder switch-trigger" href="javascript:void(0)">
                <img src="/material/img/sidebar-1.jpg" alt="">
              </a>
            </li>
            <li>
              <a class="img-holder switch-trigger" href="javascript:void(0)">
                <img src="/material/img/sidebar-2.jpg" alt="">
              </a>
            </li>
            <li>
              <a class="img-holder switch-trigger" href="javascript:void(0)">
                <img src="/material/img/sidebar-3.jpg" alt="">
              </a>
            </li>
            <li>
              <a class="img-holder switch-trigger" href="javascript:void(0)">
                <img src="/material/img/sidebar-4.jpg" alt="">
              </a>
            </li>
